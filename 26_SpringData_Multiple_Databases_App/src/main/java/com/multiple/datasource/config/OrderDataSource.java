...
public class OrderDataSource { //OracleDatabase
	...
	//this is used for reading config from application.properties
	@Bean
	...
	@Bean
	PlatformTransactionManager getOrderPTM(@Qualifier("orderEntityManagerFactory") LocalContainerEntityManagerFactoryBean containerEntityManagerFactoryBean) {
