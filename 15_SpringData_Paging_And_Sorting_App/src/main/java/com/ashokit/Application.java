...
public class Application implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		//List<Customer> customers = customerService.getCustomerInfo(3, 5);
		...
		//customerService.getAllCustomerInSortingOrder("asc", "customerName","customerLocation","cutomerId");
		
		//customerService.getCustomerInfo();
		System.out.println("CustomerDao Implementation Class:::" + customerDao.getClass().getName());
		customerDao.deleteAllByIdInBatch(Arrays.asList(12,13,14));
	}
