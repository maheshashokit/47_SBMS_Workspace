...
public class Application implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Bike b1 = new Bike("Bajaj");
		Bike b2 = new Bike("TVS");
		Bike b3 = new Bike("Hero");
		Bike b4 = new Bike("Honda");
		
		Iterable<Bike> saveAllBikes = bikeDao.saveAll(List.of(b1,b2,b3,b4));
		saveAllBikes.forEach(System.out::println);
